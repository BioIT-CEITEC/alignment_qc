...
rule merge_reports:
    ...
    params: multiqc_html = "{lib_name}.multiqc_report.html",
            ...
            multiqc_config = "/home/245829/BioRoots/alignment_qc/scripts/multiqc_config.txt"
    conda: "../wrappers/merge_reports/env.yaml"
    script: "../wrappers/merge_reports/script.py"

def single_sample_report_DNA_input(wildcards):
    input['raw_fastqc'] = expand("raw_fastq_qc/{sample}{read_pair_tag}.fastqc.html",zip,sample = sample_tab.sample_name,read_pair_tag = read_pair_tags)[0]
