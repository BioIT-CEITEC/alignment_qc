...
`r if(unique(snakemake@params$paired) == TRUE){paste0("* [Detailed raw fastq QC - (FastQC)](../../",snakemake@input$raw_fastq_R1_report,")  \\")} `
`r if(unique(snakemake@params$paired) == TRUE){paste0("* [Detailed raw fastq QC - (FastQC)](../../",snakemake@input$raw_fastq_R2_report,")  \\")} `
`r if(unique(snakemake@params$paired) == FALSE){paste0("* [Detailed raw fastq QC - (FastQC)](../../",snakemake@input$raw_fastq_SE_report,")  \\")} `
...
`r if(unique(config_json$feature_count) == TRUE){paste0("* [RNA-Seq metrics - feature count](../../",snakemake@input$feature_count,")  \\")} `
