...
`r if(unique(config_json$chip_extra_qc) == TRUE){paste0("* [All samples Phantompeakqualtools metrics (all duplicates)](../",snakemake@input$phantompeak_dups, ") \\")} `
...
`r if(unique(config_json$chip_extra_qc) == TRUE){paste0("* [All samples correlation heatmap by Deeptools (all duplicates)](../",snakemake@input$corr_heatmap_dups, ") \\")} `
...
`r if(unique(config_json$chip_extra_qc) == TRUE){paste0("* [All samples fingerprint plot by Deeptools (all duplicates)](../",snakemake@input$fingerprint_dups, ") \\")} `
----------------------------------------------------------
