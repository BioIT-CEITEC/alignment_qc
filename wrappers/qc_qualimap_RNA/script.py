...
if int(mapped_count) >= 20:
	...
	command = "export JAVA_OPTS='-Djava.io.tmpdir="+snakemake.params.tmpd+" -Xmx"+str(snakemake.resources.mem)+"G'"+\
	          " && qualimap rnaseq -bam " + snakemake.input.bam + params + extra_flags_qualimap +\
